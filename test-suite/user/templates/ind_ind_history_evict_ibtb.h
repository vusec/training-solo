...
/**
 * This template tests if the iBTB can be evicted
 *
 * For reference, single run hit results:
 * | CPU                    |   SHORT            NEAR             FAR
 * |------------------------|--------------------------------------------------|
 * | Intel Core i7-10700K   |      0 (  0.0%)   9992 ( 99.9%)      0 (  0.0%)
 * | Intel Core i7-11700    |      0 (  0.0%)   9988 ( 99.9%)      0 (  0.0%)
 * | Intel Core i9-14900K P |      0 (  0.0%)   9990 ( 99.9%)      7 (  0.1%)
 * | Intel Core 7 258V P    |      0 (  0.0%)   9987 ( 99.9%)     10 (  0.1%)
 * | Intel Core 7 258V E    |      0 (  0.0%)   9908 ( 99.1%)      0 (  0.0%)
 */
